  ...
  const breakdown = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        icon: "◜",
        color: "#60a5fa",
        count: (geometry.arcs || []).length,
        layers: countByLayer(geometry.arcs),
      },
      {
        type: "Circle",
        icon: "◯",
        color: "#38bdf8",
        count: (geometry.circles || []).length,
        layers: countByLayer(geometry.circles),
      },
      {
        type: "Ellipse",
        icon: "⬭",
        color: "#06b6d4",
        count: (geometry.ellipses || []).length,
        layers: countByLayer(geometry.ellipses),
      },
      {
        type: "Spline",
        icon: "∿",
        color: "#14b8a6",
        count: (geometry.splines || []).length,
        layers: countByLayer(geometry.splines),
      },
      {
        type: "Text / MText",
        icon: "T",
