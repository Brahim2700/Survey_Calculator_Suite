...
const main = async () => {
  ...
  const globalCases = [
    ...
    },
    {
      ...
      lon: 4.35,
      lat: 50.85,
      validator: (_codes, suggestions) => suggestions?.[0]?.code === 'EPSG:3812',
    },
    {
      sourceCode: 'EPSG:2056',
    ...
    },
    {
      ...
      expectedCode: 'EPSG:23030 or EPSG:25830',
      lon: -3.7,
      lat: 40.4,
      validator: (_codes, suggestions) => ['EPSG:23030', 'EPSG:25830'].includes(suggestions?.[0]?.code),
    },
    {
      sourceCode: 'EPSG:3003',
      expectedCode: 'EPSG:3003',
      lon: 9.2,
      lat: 45.5,
      validator: (_codes, suggestions) => suggestions?.[0]?.code === 'EPSG:3003',
    },
    {
      sourceCode: 'EPSG:31468',
      expectedCode: 'EPSG:31468',
      lon: 11.0,
      lat: 52.0,
      validator: (_codes, suggestions) => suggestions?.[0]?.code === 'EPSG:31468',
    },
    {
